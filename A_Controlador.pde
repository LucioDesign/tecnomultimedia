...
Juego juego;
  ...
  Controlador(PApplet pro) {
    ...
    pantallas[pantalla] = new Pantalla(proporcion, imag[pantalla], textos.TextoPantalla(pantalla), boton1, boton2, 100, 150, 130, 100, 80, null, null);/////
    ...
    pantallas[pantalla] = new Pantalla(proporcion, imag[pantalla], textos.TextoPantalla(pantalla), boton1, null, 300, 120, 530, 320, 80, creditos, null);//////
    ...
    pantallas[pantalla] = new Pantalla(proporcion, imag[pantalla], textos.TextoPantalla(pantalla), boton1, boton2, 20, 60, -50, 275, 40, null, null);/////
    ...
    pantalla = 5;
    juego = new Juego();
    pantallas[pantalla] = new Pantalla(proporcion, imag[pantalla], textos.TextoPantalla(pantalla), null, null, 20, 60, 525, 40, 40, null, juego);
    ...
    pantallas[pantalla] = new Pantalla(proporcion, imag[pantalla], textos.TextoPantalla(pantalla), boton1, boton2, 20, 60, 525, 40, 40, null, null);
